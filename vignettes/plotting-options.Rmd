...
If you get an error because you haven't yet installed `arphit`, see the 'Installation' section.
...
```
For more details on the `ts` package see [].
...
arphit.tsgraph(data, layout = "1", series = list("1" = c("x1","x4")), filename = "images/layout_1.png")
```
<img src = "images/layout_1.png", width = "300">
...
```
```{r, echo = FALSE, results = "hide"}
arphit.tsgraph(data, layout = "1", series = list("1" = c("x1"), "2" = c("x4")), filename = "images/layout_1_LR.png")
```
<img src = "images/layout_1_LR.png", width = "300"> 
...
```
```{r, echo = FALSE, results = "hide"}
arphit.tsgraph(data, layout = "2v", series = list("1" = c("x1"), "2" = c("x2")), filename = "images/layout_2v.png")
```
<img src = "images/layout_2v.png", width = "300"> 
...
```
```{r, echo = FALSE, results = "hide"}
arphit.tsgraph(data, layout = "2h", series = list("1" = c("x1"), "2" = c("x2"), "3" = c("x3"), "4" = c("x4")), filename = "images/layout_2h.png")
```
<img src = "images/layout_2h.png", width = "300">
...
```
```{r, echo = FALSE, results = "hide"}
arphit.tsgraph(data, layout = "2h", series = list("1" = c("x1","x2"), "3" = c("x3","x4")), filename = "images/layout_2h_L.png")
```
<img src = "images/layout_2h_L.png", width = "300">
...
```
```{r, echo = FALSE, results = "hide"}
arphit.tsgraph(data, layout = "2b2", series = list("1" = c("x1"), "2" = c("x2"), "3" = c("x3"), "4" = c("x4")), filename = "images/layout_2b2.png")
```
<img src = "images/layout_2b2.png", width = "300">
...
```
```{r, echo = FALSE, results = "hide"}
arphit.tsgraph(data, filename = "images/layout_default.png")
```
<img src = "images/layout_default.png", width = "300">
...
```
```{r, echo = FALSE, results = "hide"}
arphit.tsgraph(data, portrait = TRUE, filename = "images/layout_portrait.png")
```
<img src = "images/layout_portrait.png", width = "300">
...
```
```{r, echo = FALSE, results = "hide"}
arphit.tsgraph(data, series = list("1" = c("x1","x2"), "2" = c("x3")), bars = c("x2"), filename = "images/bars.png")
```
...
```
```{r, echo = FALSE, results = "hide"}
arphit.tsgraph(data, series = list("1" = c("x1","x2")), bars = c("x1","x2"), filename = "images/bars_stacked.png")
```
<img src = "images/bars_stacked.png", width = "300">
...
```
```{r, echo = FALSE, results = "hide"}
arphit.tsgraph(data, bars = c("x1","x2"), bar.stacked = FALSE, filename = "images/bar_beside.png")
```
<img src = "images/bar_beside.png", width = "300">
...
```
```{r, echo = FALSE, results = "hide"}
arphit.tsgraph(data, title = "Here is a Title", subtitle = "And a subtitle", filename = "images/title.png")
```
...
```
```{r, echo = FALSE, results = "hide"}
arphit.tsgraph(data, layout = "2b2", series = list("1" = c("x1"), "2" = c("x2"), "3" = c("x3"), "4" = c("x4")), paneltitle = list("1" = "Panel 1", "2" = "Panel 2", "3" = "Panel 3", "4" = "Panel 4"), filename = "images/paneltitle.png")
```
<img src = "images/paneltitle.png", width = "300">
...
```
```{r, echo = FALSE, results = "hide"}
arphit.tsgraph(data, footnote = c("Footnote 1", "Footnote 2", "etc, this can go on for a while"), filename = "images/footnote.png")
```

<img src = "images/footnote.png", width = "300">
...
```
```{r, echo = FALSE, results = "hide"}
arphit.tsgraph(data, sources = c("RBA", "ABS", "someone else"), filename = "images/sources.png")
```
<img src = "images/sources.png", width = "300">
...
```
```{r, echo = FALSE, results = "hide"}
arphit.tsgraph(data, layout = "2b2", series = list("1" = c("x1"), "2" = c("x2"), "3" = c("x3"), "4" = c("x4")), scaleunits = list("1" = "index", "2" = "ppt", "3" = "$", "4" = "000s"), filename = "images/units.png")
```
...
```
```{r, echo = FALSE, results = "hide"}
arphit.tsgraph(data, col = list("x2" = "pink", "x4" = "lightblue"), filename = "images/setcolours.png")
```
<img src = "images/setcolours.png", width = "300">
...
```
```{r, echo = FALSE, results = "hide"}
arphit.tsgraph(data, pch = 19, filename = "images/setattributeall.png")
```
<img src = "images/setattributeall.png", width = "300">
...
```
```{r, echo = FALSE, results = "hide"}
arphit.tsgraph(data, series = list("1" = c("x1"), "2" = c("x3")), ylim = list("1" = c(-10,10,5), "2" = c(-20,20,5)), filename = "images/y-individual.png")
```
<img src = "images/y-individual.png", width = "300">
...
```
```{r, echo = FALSE, results = "hide"}
arphit.tsgraph(data, layout = "2b2", series = list("1" = c("x1"), "2" = c("x2"), "3" = c("x3"), "4" = c("x4")), ylim = c(-10,10,5), filename = "images/y-uniform.png")
```
<img src = "images/y-uniform.png", width = "300">
...
```
```{r, echo = FALSE, results = "hide"}
arphit.tsgraph(data, shading = list(list(from = "x1", to = "x2", color= "red")), filename = "images/shading.png")
```
<img src = "images/shading.png", width = "300">

```
arphit.tsgraph(data, shading = list(list(from = "x1," to = "x2", color= "red")))
```
```{r, echo = FALSE, results = "hide"}
arphit.tsgraph(data, shading = list(list(from = "x1", to = "x2", color= "red"), list(from = "x3", to = "x4", color = "purple")), filename = "images/shading-layered.png")
```
<img src = "images/shading-layered.png", width = "300">
...
```
```{r, echo = FALSE, results = "hide"}
arphit.tsgraph(data, arrows = list(list(tail.x = 2000, tail.y = 10, head.x = 2001, head.y = 1, color = "darkred", panel = 1)), filename = "images/arrows.png")
```
...
```
```{r, echo = FALSE, results = "hide"}
arphit.tsgraph(data, lines = list(list(x = 2001, panel = 1), list(y = -1, color = "darkred", panel = 1, lty = 2)), filename = "images/lines.png")
```
...
```
```{r, echo = FALSE, results = "hide"}
arphit.tsgraph(data, lines = list(list(x1 = 2000, y1 = -10, x2 = 2002, y2 = 5, panel = 1)), filename = "images/specificlines.png")
```
<img src = "images/specificlines.png", width = "300">
...
```
```{r, echo = FALSE, results = "hide"}
arphit.tsgraph(data, bgshading = list(list(x1 = NA, y1 = -1, x2 = NA, y2 = 3, panel = 1)), filename = "images/shading1.png")
```
<img src = "images/shading1.png", width = "300">
...
```
```{r, echo = FALSE, results = "hide"}
arphit.tsgraph(data, layout = "2h", series = list("1" = "x4", "3" = "x2"), bgshading = list(list(x1 = NA, y1 = -1, x2 = NA, y2 = 3, panel = 1), list(x1 = 2000.5, y1 = NA, x2 = 2001.5, y2 = NA, panel = 3, color = "lightgreen")), filename = "images/shading2.png")
```
<img src = "images/shading2.png", width = "300">
