...
aesthetic. You can specify a variable to order the graph by using the `order` 
part of the aesthetic. In this example we take data and order it by a variable
`order` that is the reverse of the x variable.
```{r, results = "hide"}
