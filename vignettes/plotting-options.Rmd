...
```
colnames(ts_data)[1] <- "Series 1 name"
```
...
```
agg_qplot(ts_data, enable.autolabeller = TRUE)
```
```{r, echo = FALSE, message=FALSE, results = "hide"}
agg_qplot(ts_data, enable.autolabeller = TRUE, filename = "autolabel.png")
```
```{r, out.width = "50%", echo = FALSE, fig.align="center"}
...
* If labels are too far from their series, or if they do not have unobstructed line of sight, the auto labeller will automatically add an arrow.
