...
This document outlines all of the plotting options in `arphit` and how to use them.
...
The data is the first argument to an `arphit` call. (This means `arphit` is pipe friendly). Calling `arphit` is as simple as:
```{r, eval = FALSE}
arphit(data)
```
```{r, echo = FALSE, results = "hide"}
arphit(data, filename = "data_1.png")
```
...
```{r, echo = FALSE, results = "hide"}
mytsdata <- ts(data.frame(x1 = rnorm(10)), frequency = 4, start = c(2000, 1))
arphit(mytsdata, filename = "data_ts.png")
```
```{r, out.width = "50%", echo = FALSE, fig.align="center"}
...
arphit(mydataframe, x = "date")
```
```{r, echo = FALSE, results = "hide"}
mydataframe <- data.frame(date = seq.Date(from = as.Date("2000-01-01"), length.out = 10, by = "quarter"), x1 = rnorm(10))
arphit(mydataframe, x = "date", filename = "data_df.png")
```
```{r, out.width = "50%", echo = FALSE, fig.align="center"}
...
arphit(categoricaldata, x = "categoryname")
```
```{r, echo = FALSE, results = "hide"}
categoricaldata <- data.frame(categoryname = letters[1:5], value = rnorm(5))
arphit(categoricaldata, x = "categoryname", filename = "data_categorical.png")
```
```{r, out.width = "50%", echo = FALSE, fig.align="center"}
...
arphit(scatterdata, x = "x")
```
```{r, echo = FALSE, results = "hide"}
scatterdata <- data.frame(x = rnorm(20), y = rnorm(20))
arphit(scatterdata, x = "x", filename = "data_scatter.png")
```
```{r, out.width = "50%", echo = FALSE, fig.align="center"}
...
arphit(data = list("1" = data1, "2" = data2), x = list("1" = "date", "2" = "years"), layout = "2v")
```
```{r, echo = FALSE, results = "hide"}
data1 <- data.frame(date = seq.Date(from = as.Date("2000-01-01"), length.out = 10, by = "quarter"), x1 = rnorm(10))
data2 <- data.frame(years = seq.Date(from = as.Date("2000-01-01"), length.out = 4, by = "year"), x2 = rnorm(4))
arphit(data = list("1" = data1, "2" = data2), x = list("1" = "date", "2" = "years"), layout = "2v", filename = "multidata.png")
```
```{r, out.width = "50%", echo = FALSE, fig.align="center"}
...
Each layout has a number of panels where series can be placed. *Right hand side axes count as separate axes
in some layouts.* Panels are numbered from left to right, top to bottom.
...
```{r, eval = FALSE}
arphit(data, layout = "1", series = list("1" = c("x1","x4")))
```
```{r, echo = FALSE, results = "hide"}
arphit(data, layout = "1", series = list("1" = c("x1","x4")), filename = "layout_1.png")
```
```{r, out.width = "50%", echo = FALSE, fig.align="center"}
...
```{r, eval = FALSE}
arphit(data, layout = "1", series = list("1" = c("x1"), "2" = c("x4")))
```
```{r, echo = FALSE, results = "hide"}
arphit(data, layout = "1", series = list("1" = c("x1"), "2" = c("x4")), filename = "layout_1_LR.png")
```
```{r, out.width = "50%", echo = FALSE, fig.align="center"}
...
```{r, eval = FALSE}
arphit(data, layout = "2v", series = list("1" = c("x1"), "2" = c("x2")))
```
```{r, echo = FALSE, results = "hide"}
arphit(data, layout = "2v", series = list("1" = c("x1"), "2" = c("x2")), filename = "layout_2v.png")
```
```{r, out.width = "50%", echo = FALSE, fig.align="center"}
...
```{r, eval = FALSE}
arphit(data, layout = "2h", series = list("1" = c("x1"), "2" = c("x2"), "3" = c("x3"), "4" = c("x4")))
```
```{r, echo = FALSE, results = "hide"}
arphit(data, layout = "2h", series = list("1" = c("x1"), "2" = c("x2"), "3" = c("x3"), "4" = c("x4")), filename = "layout_2h.png")
```
```{r, out.width = "50%", echo = FALSE, fig.align="center"}
...
```{r, eval = FALSE}
arphit(data, layout = "2h", series = list("1" = c("x1","x2"), "3" = c("x3","x4")))
```
```{r, echo = FALSE, results = "hide"}
arphit(data, layout = "2h", series = list("1" = c("x1","x2"), "3" = c("x3","x4")), filename = "layout_2h_L.png")
```
```{r, out.width = "50%", echo = FALSE, fig.align="center"}
...
```{r, eval = FALSE}
arphit(data, layout = "2b2", series = list("1" = c("x1"), "2" = c("x2"), "3" = c("x3"), "4" = c("x4")))
```
```{r, echo = FALSE, results = "hide"}
arphit(data, layout = "2b2", series = list("1" = c("x1"), "2" = c("x2"), "3" = c("x3"), "4" = c("x4")), filename = "layout_2b2.png")
```
```{r, out.width = "50%", echo = FALSE, fig.align="center"}
...
```{r, eval = FALSE}
arphit(data, layout = "3v", series = list("1" = c("x1"), "2" = c("x2"), "3" = c("x3")))
```
```{r, echo = FALSE, results = "hide"}
arphit(data, layout = "3v", series = list("1" = c("x1"), "2" = c("x2"), "3" = c("x3")), filename = "layout_3v.png")
```
```{r, out.width = "50%", echo = FALSE, fig.align="center"}
...
```{r, eval = FALSE}
arphit(data, layout = "3h", series = list("1" = c("x1"), "2" = c("x2"), "3" = c("x1"), "5" = "x1"))
```
```{r, echo = FALSE, results = "hide"}
arphit(data, layout = "3h", series = list("1" = c("x1"), "2" = c("x2"), "3" = c("x1"), "5" = "x1"), filename = "layout_3h.png")
```
```{r, out.width = "50%", echo = FALSE, fig.align="center"}
...
```{r, eval = FALSE}
arphit(data, layout = "3b2", series = list("1" = "x1", "2" = "x2", "3" = "x1", "4" = "x2", "5" = "x1", "6" = "x4"))
```
```{r, echo = FALSE, results = "hide"}
arphit(data, layout = "3b2", series = list("1" = "x1", "2" = "x2", "3" = "x1", "4" = "x2", "5" = "x1", "6" = "x4"), filename = "layout_3b2.png")
```
```{r, out.width = "50%", echo = FALSE, fig.align="center"}
...
```{r, eval = FALSE}
arphit(data, layout = "4h", series = list("1" = "x1", "2" = "x2", "3" = "x1", "4" = "x2", "5" = "x1", "6" = "x4", "7" = "x2", "8" = c("x1","x2")))
```
```{r, echo = FALSE, results = "hide"}
arphit(data, layout = "4h", series = list("1" = "x1", "2" = "x2", "3" = "x1", "4" = "x2", "5" = "x1", "6" = "x4", "7" = "x2", "8" = c("x1","x2")), filename = "layout_4h.png")
```
```{r, out.width = "50%", echo = FALSE, fig.align="center"}
...
```{r, eval = FALSE}
arphit(data, layout = "4b2", series = list("1" = "x1", "2" = "x2", "3" = "x1", "4" = "x2", "5" = "x1", "6" = "x4", "7" = "x2", "8" = c("x1","x2")))
```
```{r, echo = FALSE, results = "hide"}
arphit(data, layout = "4b2", series = list("1" = "x1", "2" = "x2", "3" = "x1", "4" = "x2", "5" = "x1", "6" = "x4", "7" = "x2", "8" = c("x1","x2")), filename = "layout_4b2.png")
```
```{r, out.width = "50%", echo = FALSE, fig.align="center"}
...
This can be useful if you want a quick plot of just a few series.

```{r, eval = FALSE}
arphit(data)
```
```{r, echo = FALSE, results = "hide"}
arphit(data, filename = "layout_default.png")
```
```{r, out.width = "50%", echo = FALSE, fig.align="center"}
...
```{r, eval = FALSE}
arphit(data, portrait = TRUE)
```
```{r, echo = FALSE, results = "hide"}
arphit(data, portrait = TRUE, filename = "layout_portrait.png")
```
```{r, out.width = "50%", echo = FALSE, fig.align="center"}
...
```{r, eval = FALSE}
arphit(data, series = list("1" = c("x1","x2"), "2" = c("x3")), bars = c("x2"))
```
```{r, echo = FALSE, results = "hide"}
arphit(data, series = list("1" = c("x1","x2"), "2" = c("x3")), bars = c("x2"), filename = "bars.png")
```
```{r, out.width = "50%", echo = FALSE, fig.align="center"}
...
```{r, eval = FALSE}
arphit(data, series = list("1" = c("x1","x2")), bars = c("x1","x2"))
```
```{r, echo = FALSE, results = "hide"}
arphit(data, series = list("1" = c("x1","x2")), bars = c("x1","x2"), filename = "bars_stacked.png")
```
```{r, out.width = "50%", echo = FALSE, fig.align="center"}
...
```{r, eval = FALSE}
arphit(data, bars = c("x1","x2"), bar.stacked = FALSE)
```
```{r, echo = FALSE, results = "hide"}
arphit(data, bars = c("x1","x2"), bar.stacked = FALSE, filename = "bar_beside.png")
```
```{r, out.width = "50%", echo = FALSE, fig.align="center"}
...
```{r, eval = FALSE}
arphit(data, title = "Here is a Title", subtitle = "And a subtitle")
```
```{r, echo = FALSE, results = "hide"}
arphit(data, title = "Here is a Title", subtitle = "And a subtitle", filename = "title.png")
```
```{r, out.width = "50%", echo = FALSE, fig.align="center"}
...
```{r, eval = FALSE}
arphit(data, title = "Here is a very very very long title that arphit will automatically put a breka in", subtitle = "And a subtitle\nwith a break too")
```
```{r, echo = FALSE, results = "hide"}
...
```{r, eval = FALSE}
arphit(data, layout = "2b2", series = list("1" = c("x1"), "2" = c("x2"), "3" = c("x3"), "4" = c("x4")), paneltitle = list("1" = "Panel 1", "2" = "Panel 2", "3" = "Panel 3", "4" = "Panel 4"))
```
```{r, echo = FALSE, results = "hide"}
arphit(data, layout = "2b2", series = list("1" = c("x1"), "2" = c("x2"), "3" = c("x3"), "4" = c("x4")), paneltitle = list("1" = "Panel 1", "2" = "Panel 2", "3" = "Panel 3", "4" = "Panel 4"), filename = "paneltitle.png")
```
```{r, out.width = "50%", echo = FALSE, fig.align="center"}
...
```{r, eval = FALSE}
arphit(data, footnote = c("Footnote 1", "Footnote 2", "etc, this can go on for a while"))
```
```{r, echo = FALSE, results = "hide"}
arphit(data, footnote = c("Footnote 1", "Footnote 2", "etc, this can go on for a while"), filename = "footnote.png")
```
```{r, out.width = "50%", echo = FALSE, fig.align="center"}
...
```{r, eval = FALSE}
arphit(data, sources = c("RBA", "ABS", "someone else"))
```
```{r, echo = FALSE, results = "hide"}
arphit(data, sources = c("RBA", "ABS", "someone else"), filename = "sources.png")
```
```{r, out.width = "50%", echo = FALSE, fig.align="center"}
...
```{r, eval = FALSE}
arphit(data, layout = "2b2", series = list("1" = c("x1"), "2" = c("x2"), "3" = c("x3"), "4" = c("x4")), yunits = list("1" = "index", "2" = "ppt", "3" = "$", "4" = "000s"))
```
```{r, echo = FALSE, results = "hide"}
arphit(data, layout = "2b2", series = list("1" = c("x1"), "2" = c("x2"), "3" = c("x3"), "4" = c("x4")), yunits = list("1" = "index", "2" = "ppt", "3" = "$", "4" = "000s"), filename = "units.png")
```
```{r, out.width = "50%", echo = FALSE, fig.align="center"}
...
```
```{r, echo = FALSE, results = "hide"}
arphit(data, layout = "2b2", series = list("1" = c("x1"), "2" = c("x2"), "3" = c("x3"), "4" = c("x4")), yunits = "000s", filename = "units-all.png")
```
```{r, out.width = "50%", echo = FALSE, fig.align="center"}
...
```{r, eval = FALSE}
scatterdata <- data.frame(x = rnorm(20), y = rnorm(20))
arphit(scatterdata, x = "x", xunits = "ppt")
```
```{r, echo = FALSE, results = "hide"}
scatterdata <- data.frame(x = rnorm(20), y = rnorm(20))
arphit(scatterdata, x = "x", filename = "x-units.png")
```
```{r, out.width = "50%", echo = FALSE, fig.align="center"}
...
series `x1` and `x3`.
```{r, eval = FALSE}
arphit(data, col = list("x2" = "pink", "x4" = "lightblue"))
```
```{r, echo = FALSE, results = "hide"}
arphit(data, col = list("x2" = "pink", "x4" = "lightblue"), filename = "setcolours.png")
```
```{r, out.width = "50%", echo = FALSE, fig.align="center"}
...
```
```{r, echo = FALSE, results = "hide"}
arphit(data, pch = 19, filename = "setattributeall.png")
```
```{r, out.width = "50%", echo = FALSE, fig.align="center"}
...
The RBA color palette can be accessed using `RBA["Green1"]` etc. For instance:
```{r, eval = FALSE}
arphit(data, series = list("1" = c("x2", "x4")), col = list("x2" = RBA["Red1"], "x4" = RBA["Blue10"]))
```
```{r, echo = FALSE, results = "hide"}
arphit(data, series = list("1" = c("x2", "x4")), col = list("x2" = RBA["Red1"], "x4" = RBA["Blue10"]), filename = "rbacolours.png")
```
```{r, out.width = "50%", echo = FALSE, fig.align="center"}
...
You can access the default colors using the alias `RBA["Default1"]` etc.
...
```{r, eval = FALSE}
arphit(data, series = list("1" = c("x1"), "2" = c("x3")), ylim = list("1" = list(min = -10, max = 10, nsteps = 5), "2" = list(min = -20, max = 20, nsteps = 5)))
```
```{r, echo = FALSE, results = "hide"}
arphit(data, series = list("1" = c("x1"), "2" = c("x3")), ylim = list("1" = list(min = -10, max = 10, nsteps = 5), "2" = list(min = -20, max = 20, nsteps = 5)), filename = "y-individual.png")
```
```{r, out.width = "50%", echo = FALSE, fig.align="center"}
...
```{r, eval = FALSE}
arphit(data, layout = "2b2", series = list("1" = c("x1"), "2" = c("x2"), "3" = c("x3"), "4" = c("x4")), ylim = list(min = -10, max = 10, nsteps = 5))
```
```{r, echo = FALSE, results = "hide"}
arphit(data, layout = "2b2", series = list("1" = c("x1"), "2" = c("x2"), "3" = c("x3"), "4" = c("x4")), ylim = list(min = -10, max = 10, nsteps = 5), filename = "y-uniform.png")
```
```{r, out.width = "50%", echo = FALSE, fig.align="center"}
...
For "2b2" and "2v" layouts, you can drop the the first tick of the right hand panel by setting `dropxlabel = TRUE`. This prevents the last label of the left hand panel overlapping the first of the right hand panel.

```{r, eval = FALSE}
arphit(data, layout = "2b2", series = list("1" = c("x1"), "2" = c("x2"), "3" = c("x3"), "4" = c("x4")), dropxlabel = TRUE)
```
```{r, echo = FALSE, results = "hide"}
arphit(data, layout = "2b2", series = list("1" = c("x1"), "2" = c("x2"), "3" = c("x3"), "4" = c("x4")), dropxlabel=TRUE, filename = "dropxlabel.png")
```
```{r, out.width = "50%", echo = FALSE, fig.align="center"}
...
```{r, eval = FALSE}
arphit(data, shading = list(list(from = "x1", to = "x2", color= "red")))
```
```{r, echo = FALSE, results = "hide"}
arphit(data, shading = list(list(from = "x1", to = "x2", color= "red")), filename = "shading.png")
```
```{r, out.width = "50%", echo = FALSE, fig.align="center"}
...
```{r, eval = FALSE}
arphit(data, shading = list(list(from = "x1", to = "x2", color= "red"), list(from = "x3", to = "x4", color = "purple")))
```
```{r, echo = FALSE, results = "hide"}
arphit(data, shading = list(list(from = "x1", to = "x2", color= "red"), list(from = "x3", to = "x4", color = "purple")), filename = "shading-layered.png")
```
```{r, out.width = "50%", echo = FALSE, fig.align="center"}
...
```{r, eval = FALSE}
arphit(data, labels = list(list(x = 2001, y = 2, text = "A label", panel = 1, color = "red"), list(x = 2004, y = 10, text = "A label\n(On two lines!)", panel = 1, color = "green")))
```
```{r, echo = FALSE, results = "hide"}
arphit(data, labels = list(list(x = 2001, y = 2, text = "A label", panel = 1, color = "red"), list(x = 2002, y = 10, text = "A label\n(On two lines!)", panel = 1, color = "green")), filename = "labels.png")
```
```{r, out.width = "50%", echo = FALSE, fig.align="center"}
...
```{r, eval = FALSE}
arphit(data, arrows = list(list(tail.x = 2000, tail.y = 10, head.x = 2001, head.y = 1, color = "darkred", panel = 1)))
```
```{r, echo = FALSE, results = "hide"}
arphit(data, arrows = list(list(tail.x = 2000, tail.y = 10, head.x = 2001, head.y = 1, color = "darkred", panel = 1)), filename = "arrows.png")
```
```{r, out.width = "50%", echo = FALSE, fig.align="center"}
...
```{r, eval = FALSE}
arphit(data, lines = list(list(x = 2001, panel = 1), list(y = -1, color = "darkred", panel = 1, lty = 2)))
```
```{r, echo = FALSE, results = "hide"}
arphit(data, lines = list(list(x = 2001, panel = 1), list(y = -1, color = "darkred", panel = 1, lty = 2)), filename = "lines.png")
```
```{r, out.width = "50%", echo = FALSE, fig.align="center"}
...
```{r, eval = FALSE}
arphit(data, lines = list(list(x1 = 2000, y1 = -10, x2 = 2002, y2 = 5, panel = 1)))
```
```{r, echo = FALSE, results = "hide"}
arphit(data, lines = list(list(x1 = 2000, y1 = -10, x2 = 2002, y2 = 5, panel = 1)), filename = "specificlines.png")
```
```{r, out.width = "50%", echo = FALSE, fig.align="center"}
...
```{r, eval = FALSE}
arphit(data, bgshading = list(list(x1 = NA, y1 = -1, x2 = NA, y2 = 3, panel = 1)))
```
```{r, echo = FALSE, results = "hide"}
arphit(data, bgshading = list(list(x1 = NA, y1 = -1, x2 = NA, y2 = 3, panel = 1)), filename = "shading1.png")
```
```{r, out.width = "50%", echo = FALSE, fig.align="center"}
...
```{r, eval = FALSE}
arphit(data, layout = "2h", series = list("1" = "x4", "3" = "x2"), bgshading = list(list(x1 = NA, y1 = -1, x2 = NA, y2 = 3, panel = 1), list(x1 = 2000.5, y1 = NA, x2 = 2001.5, y2 = NA, panel = 3, color = "lightgreen")))
```
```{r, echo = FALSE, results = "hide"}
arphit(data, layout = "2h", series = list("1" = "x4", "3" = "x2"), bgshading = list(list(x1 = NA, y1 = -1, x2 = NA, y2 = 3, panel = 1), list(x1 = 2000.5, y1 = NA, x2 = 2001.5, y2 = NA, panel = 3, color = "lightgreen")), filename = "shading2.png")
```
```{r, out.width = "50%", echo = FALSE, fig.align="center"}
...
```{r, eval = FALSE}
arphit(data, layout = "2b2", yaxislabels = "A y axis label", xaxislabels = "An x label")
```
```{r, echo = FALSE, results = "hide"}
arphit(data, layout = "2b2", yaxislabels = "A y axis label", xaxislabels = "An x label", filename = "oneaxislabel.png")
```
```{r, out.width = "50%", echo = FALSE, fig.align="center"}
...
```{r, eval = FALSE}
arphit(data, layout = "2b2", yaxislabels = list("1" = "Foo", "3" = "Bar"), xaxislabels = list("3" = "An x label", "4" = "Another x label")
```
```{r, echo = FALSE, results = "hide"}
arphit(data, layout = "2b2", yaxislabels = list("1" = "Foo", "3" = "Bar"), xaxislabels = list("3" = "An x label", "4" = "Another x label"), filename = "differentaxislabel.png")
```
```{r, out.width = "50%", echo = FALSE, fig.align="center"}
...
```
```{r, echo = FALSE, results = "hide"}
arphit(categoricaldata, x = "categoryname", srt = 45, filename = "xlabel-rotation.png")
```
```{r, out.width = "50%", echo = FALSE, fig.align="center"}
...
```{r, eval = FALSE}
arphit(joining_data, joined = TRUE)
```
```{r, echo = FALSE, results = "hide"}
arphit(joining_data, joined = TRUE, filename = "joined.png")
```
```{r, out.width = "50%", echo = FALSE, fig.align="center"}
...
```{r, eval = FALSE}
arphit(joining_data, joined = FALSE)
```
```{r, echo = FALSE, results = "hide"}
arphit(joining_data, joined = FALSE, filename = "unjoined.png")
```
```{r, out.width = "50%", echo = FALSE, fig.align="center"}
...
```{r, eval = FALSE}
arphit(data, legend = TRUE)
```
```{r, echo = FALSE, results = "hide"}
arphit(data, legend = TRUE, filename = "legend.png")
```
```{r, out.width = "50%", echo = FALSE, fig.align="center"}
knitr::include_graphics("legend.png")
```

`arphit` is smart and will ignore duplicate series in multiple panels (i.e. it will only put in one legend entry).
...
```{r, eval = FALSE}
arphit(data, filename = "my_filename.png")
```
...
```{r, eval = FALSE}
arphit(data, filename = "my_filename.png")
arphit(data, filename = "my_filename.emf")
arphit(data, filename = "my_filename.pdf")
```
