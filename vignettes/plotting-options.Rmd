...
There are four types of layers, `agg_line`, `agg_col`, `agg_point` and `agg_step`. These are used nearly identically to produce line, column, scatter and step graphs respectively:
```{r, results = "hide"}
