...
```
arphit.tsgraph(data, series = ("1" = c("x2", "x4")), col = list("x2" = RBA["Red1"], "x4" = RBA["Blue10"]))
```
```{r, echo = FALSE, results = "hide"}
arphit.tsgraph(data, series = ("1" = c("x2", "x4")), col = list("x2" = RBA["Red1"], "x4" = RBA["Blue10"]), filename = "rbacolours.png")
```
```{r, out.width = "50%", echo = FALSE, fig.align="center"}
