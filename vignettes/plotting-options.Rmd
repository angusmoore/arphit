...
By default, on "2b2" and "2v" layouts, the first tick of the right hand panel is not displayed. This prevents the last label of the left hand panel overlapping the first of the right hand panel. You can force the first tick to display by setting `dropxlabel = FALSE`.
