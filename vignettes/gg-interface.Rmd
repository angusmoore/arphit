...
For line layers you can also specify `pch`, `lty` and `lwd`. These function identically to specifying colours (i.e. supplying one will apply it to the whole layer; specifying a vector will loop through it). The plotting options vignette explains what these three options do.
